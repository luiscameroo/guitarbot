...
ISR:
    movia r8, LEGO
    ldwio r9, (r8)
    andi r10, r9, 0b010000
    beq r10, r0, turn_off
turn_on:
    andi r10, r9, 0b101111 
    stwio r10, (r8)
    br ISR_done
turn_off:
    ori r10, r9, 0b010000
...
_start:
    ...
    movia r9, 0xFB3FFBFF # 23-26: 0b0110, 22: 0, 10: 0
    stwio r9, (r8)

    movia r9, 0xFB5FFFFF # 23-26: 0b0111, 21:0
    stwio r9, (r8)

    movia r9, 0x08000000
    stwio r9, 8(r8)

	movia r9, 0xFFDFFFCF # 21:0, 5-4: 0b00
	stwio r9, (r8)
